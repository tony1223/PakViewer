...
namespace Lin.Helper.Core.Dat
{
    ...
    public static class DatTools
    {
        ...
        internal static byte[] GetAesKey() => AES_KEY;
    }
    ...
    public class DatFile
    {
        ...
        public DatFile(string filepath)
        {
            ...
            IV = DatTools.GetIVFromFilename(FileName);
        ...
        public byte[] DecryptIndex()
        {
            ...
            using (var fs = new FileStream(FilePath, FileMode.Open, FileAccess.Read))
            {
                ...
                {
                    IndexData = DatTools.DecryptAesCbc(encryptedIndex, DatTools.GetAesKey(), IV);
                }
                else
                {
        ...
        public List<DatIndexEntry> ParseEntries()
        {
            ...
            Entries = DatTools.ParseIndex(IndexData, FilePath);
            return Entries;
        }
        ...
        {
            return DatTools.DecryptAesCbc(encryptedData, DatTools.GetAesKey(), IV);
        }
